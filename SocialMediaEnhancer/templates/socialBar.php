<div class="socialBar clear cf">
	<div class="sbButton">
		<a href="<?php comments_link(); ?>" class="sbComments" rel="sme nofollow">Kommentieren</a>
		<span class="sbButtonCount"><span><?php comments_number('0', '1', '%'); ?></span></span>
	</div>

	<div class="sbButton">
		<a href="<?php echo $post->socialInfo['twitter']['shareUrl']; ?>" class="sbTwitter" rel="sme nofollow">Twittern</a>
		<span class="sbButtonCount"><span><?php echo $post->socialInfo['twitter']['count']; ?></span></span>
	</div>

	<div class="sbButton">
		<a href="<?php echo $post->socialInfo['facebook']['shareUrl']; ?>" class="sbFacebook" rel="sme nofollow">Teilen</a>
