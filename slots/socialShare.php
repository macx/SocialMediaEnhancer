<div class="socialShare cf">
	...
	<div class="sosButton last">
		<span class="sosButtonCount"><span><?php echo $post->socialInfo['plusone']['count']; ?></span></span>
		<a href="<?php echo $post->socialInfo['plusone']['shareUrl']; ?>" class="sosPlusOne" rel="external nofollow">+1</a>
	</div>
</div>
